...
import { ChatBubbleLeftEllipsisIcon, ShareIcon } from '@heroicons/react/24/outline';
...
const Post = ({ name, message, email, postImage, image, timestamp }) => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex justify-between items-center rounded-b-2xl bg0white-shadow0md text-gray-400 border-t'>
